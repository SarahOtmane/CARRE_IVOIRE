...
<template>
  <div class="space-y-10 pb-10">
    ...
    <section class="space-y-6">
      <div class="flex items-end justify-between border-b border-cocoa/12 pb-6">
        <div>
      ...
      <div v-if="showTvaForm" class="border border-cocoa/20 bg-ivory p-6">
        ...
        <div class="mt-5 flex gap-3">
          ...
          <button
            type="button"
            class="border border-cocoa/40 px-5 py-3 font-body text-[11px] uppercase tracking-[0.16em] text-cocoa"
            @click="cancelTvaForm"
          >
            Annuler
          </button>
      ...
      <div v-else-if="taxRates.length === 0 && !showTvaForm" class="border border-cocoa/12 bg-ivory px-8 py-10 text-center">
      ...
      <div v-else-if="taxRates.length > 0" class="overflow-hidden border border-cocoa/12 bg-ivory">
        <div class="grid grid-cols-[minmax(0,1fr)_120px_80px] border-b border-cocoa/12 px-6 py-4 font-body text-[10px] uppercase tracking-[0.22em] text-cocoa/45">
          <span>Libellé</span>
        ...
        <div
          ...
          :key="tva.id"
          class="grid grid-cols-[minmax(0,1fr)_120px_80px] items-center gap-4 border-b border-cocoa/8 px-6 py-5 last:border-b-0"
        >
