...
<template>
  <div class="space-y-8 pb-10">
    ...
    >
      <article class="border border-cocoa bg-ivory p-8">
        <div class="flex flex-wrap items-start justify-between gap-4 border-b border-cocoa pb-6">
          <div>
        ...
        <div class="mt-6 grid gap-4 sm:grid-cols-3">
          <div class="border border-cocoa p-4">
        ...
        <div v-if="current.shippingAddress" class="mt-6 border border-cocoa p-4">
        ...
        <div class="mt-8 border-t border-cocoa pt-6">
          <div class="font-body text-[10px] uppercase tracking-[0.22em] text-cocoa/45">Articles</div>
          <div class="mt-4 divide-y divide-cocoa/8 border border-cocoa bg-beige/30 px-4">
            <div
          ...
          <div class="mt-6 space-y-2 font-body text-sm text-cocoa">
            <div class="flex justify-between border-t border-cocoa pt-3 font-display text-2xl">
              <span>Total</span>
      ...
      <aside class="space-y-6">
        <article class="border border-cocoa bg-ivory p-6">
          <div class="font-body text-[10px] uppercase tracking-[0.22em] text-cocoa/45">Statut</div>
          <select
            :value="current.status"
            class="mt-4 w-full border border-cocoa bg-beige/20 px-3 py-2.5 font-body text-base text-cocoa outline-none focus:border-cocoa/60"
            @change="changeStatus"
          >
    ...
    <div v-else class="border border-cocoa bg-ivory px-8 py-12 text-center">
