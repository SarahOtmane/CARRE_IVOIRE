...
<template>
  <div class="space-y-10 pb-10">
    <section class="border-b border-cocoa/40 pb-10">
    ...
    <section class="grid gap-0 border border-cocoa/40 bg-ivory lg:grid-cols-4">
      <article
        v-for="(item, index) in kpis"
        :key="item.label"
        class="border-b border-cocoa/40 px-6 py-7 lg:border-b-0 lg:border-r lg:last:border-r-0"
      >
        <div
    ...
    >
      <article class="border border-cocoa/40 bg-ivory">
        <div
          class="flex items-center justify-between border-b border-cocoa/40 px-6 py-5"
        >
        ...
        <div class="divide-y divide-cocoa/8 px-6">
          ...
          >
            ...
            <span
              class="justify-self-end border border-cocoa/40 px-3 py-1 font-body text-[10px] uppercase tracking-[0.18em] text-cocoa/70"
      ...
      <aside class="space-y-8">
        <article class="border border-cocoa/40 bg-ivory">
          <div class="border-b border-cocoa/40 px-6 py-5">
