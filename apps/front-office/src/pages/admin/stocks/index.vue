...
<template>
  <div class="space-y-8 pb-10">
    ...
    <section class="grid gap-4 sm:grid-cols-3">
      <article class="border border-cocoa bg-ivory p-5">
    ...
    <section v-else class="overflow-hidden border border-cocoa bg-ivory">
      <div
        class="grid grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_92px_132px_96px] border-b border-cocoa px-6 py-4 font-body text-[10px] uppercase tracking-[0.22em] text-cocoa/45"
      >
        <span>Produit</span>
        <span>Catégorie</span>
      ...
      <div
        ...
        :key="product.id"
        class="grid grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_92px_132px_96px] items-center gap-4 border-b border-cocoa px-6 py-5 last:border-b-0"
      >
        <div>
        ...
        <label class="flex items-center gap-3 border-b border-cocoa pb-2">
