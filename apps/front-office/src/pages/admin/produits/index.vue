...
<template>
  <div class="space-y-8 pb-10">
      ...
      <div class="flex flex-wrap items-end justify-between gap-6">
        <div>
          ...
          <h2 class="mt-4 font-display text-5xl leading-[0.92] text-cacao sm:text-6xl">
            Le catalogue,
            <span class="italic text-cacao/55">à votre main.</span>
          </h2>
        </div>
        <button
          type="button"
    ...
    <section class="flex flex-wrap items-center gap-4 border border-cacao bg-ivoire px-6 py-5">
      ...
      <label class="flex items-center gap-3 border-b border-cacao pb-3">
        <span class="font-body text-[10px] uppercase tracking-[0.22em] text-cacao/45">Catégorie</span>
        <select
          v-model="categoryFilter"
          class="bg-transparent font-body text-sm text-cacao outline-none"
        >
      ...
      <div class="ml-auto font-body text-[11px] uppercase tracking-[0.16em] text-cacao/55">
