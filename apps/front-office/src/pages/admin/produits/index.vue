...
<template>
  <div class="space-y-8 pb-10">
    ...
    <section class="flex flex-wrap items-center gap-4 border border-cocoa bg-ivory px-6 py-5">
      ...
      <label class="flex items-center gap-3 border-b border-cocoa pb-3">
    ...
    <section v-else class="overflow-hidden border border-cocoa bg-ivory">
      <div
        class="grid grid-cols-[minmax(0,2.2fr)_minmax(0,1.4fr)_108px_130px_110px_84px] border-b border-cocoa px-6 py-4 font-body text-[10px] uppercase tracking-[0.22em] text-cocoa/45"
      >
        <span>Nom</span>
        <span>Catégorie</span>
      ...
      <button
        ...
        :key="product.id"
        type="button"
        class="grid w-full grid-cols-[minmax(0,2.2fr)_minmax(0,1.4fr)_108px_130px_110px_84px] items-center gap-4 border-b border-cocoa px-6 py-5 text-left transition-colors duration-200 hover:bg-beige/50 last:border-b-0"
      ...
      >
        ...
        <button
          ...
          :class="product.stockStatus === 'out_of_stock'
            ...
            : 'border-cocoa text-cocoa hover:border-cocoa/50'"
